...
<script language="JavaScript">
	...
	$(document).ready(
			function() {
				$("select[name='shop_category'] option[value='${dto.shop_category}']").attr("selected","selected");
				$("select[name='shop_bank'] option[value='${dto.shop_bank}']").attr("selected","selected");
			});
</script>
<!-- 주소api -->
			...
			<div class="form-inline mb-1">
				...
				<div class="form-group mr-0 ml-auto">
					<input type="file" name="img" class="form-control-file-sm"/><small>
						현재이미지-></small>
					<IMG src="/Jumoon25/owner_shop_image/${dto.shop_image}" width="50" height="50"/>
					<input type="text" hidden="" value="${dto.shop_image}" name="org_image"/>
				</div>
			</div>
			<div class="form-group mb-1">
