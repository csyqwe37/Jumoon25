...
<script language="JavaScript">
	...
	$(document)
			.ready(
					function() {
						$(
								"select[name='shop_category'] option[value='${dto.shop_category}']")
								.attr("selected", "selected");
						$(
								"select[name='shop_bank'] option[value='${dto.shop_bank}']")
								.attr("selected", "selected");
					});
</script>
<!-- 주소api -->
	...
	<div class="wrap">
		...
		<div class="container w-50 py-3">
			...
			<form method="post" enctype="multipart/form-data"
				action="/Jumoon25/owner_management/owner_shop_modifyPro.do"
				...
				<div class="form-inline mb-1">
					<div class="form-group mr-auto ml-0">
						<input class="form-control form-control-sm" name="shop_name"
							type="text" placeholder="업체명" size="70" value="${dto.shop_name}">
					</div>
				...
				<div class="form-inline mb-1">
					...
					<div class="form-group mr-0 ml-auto">
						<input type="file" name="img" class="form-control-file-sm" /><small>
							현재이미지-></small> <IMG src="/Jumoon25/owner_shop_image/${dto.shop_image}"
							width="50" height="50" /> <input type="text" hidden=""
							value="${dto.shop_image}" name="org_image" />
					</div>
				</div>
				<div class="form-group mb-1">
					<textarea class="form-control form-control-sm" name="shop_comment"
						type="text" placeholder="사장님 한마디(공지사항)" maxlength="120">${dto.shop_comment}</textarea>
				</div>
				<div class="form-inline">
					<div class="form-group mr-auto ml-0">
						<input class="form-control form-control-sm" name="shop_crNum"
							type="text" placeholder="사업자등록번호(-없이 10자리)" maxlength="10"
							size="60" readonly="" value="${dto.shop_crNum}">
					</div>
					<div class="form-group mr-0 ml-auto">
