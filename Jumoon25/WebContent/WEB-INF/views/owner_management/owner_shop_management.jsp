				...
				<c:forEach var="dto" items="${list}">
					<tr>
						...
						<td><div class="btn-group" role="group">
								<button class="btn btn-secondary" type="button" onclick="javascript:window.location='owner_shop_pause.do?crNum=${dto.shop_crNum}'">일시정지</button>
								&nbsp
								<button class="btn btn-secondary" type="button" onclick="javascript:window.location='owner_shop_modify.do?crNum=${dto.shop_crNum}'">수 정</button>
								&nbsp
								<button class="btn btn-secondary" type="button" onclick="javascript:window.location='owner_shop_delete.do?crNum=${dto.shop_crNum}'">삭 제</button>
								&nbsp
								<button class="btn btn-secondary" type="button" onclick="javascript:window.location='owner_menu_management.do?crNum=${dto.shop_crNum}'">메뉴관리</button>
							</div></td>
					</tr>
				</c:forEach>
